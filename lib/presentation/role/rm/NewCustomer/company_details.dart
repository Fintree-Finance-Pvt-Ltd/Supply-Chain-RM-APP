...
//   const CompanyDetails({super.key, this.isResume = false});
...
//     if (widget.isResume && draftList.isNotEmpty) {
//       // 🔁 RESUME → update existing draft
//       currentDraft = draftList.removeLast();
//     } else {
//       // 🆕 NEW CUSTOMER → create NEW draft
//       currentDraft = {};
//     }

//     currentDraft["company"] = companyData;
//     currentDraft["lastStep"] = "applicantDetails";
...
//   // // }
//   // // // Update data
//   // // currentDraft["companyData"] = companyData;
//   // // currentDraft["lastStep"] = "applicantDetails";
...
//   //   // If draft exists → update last
//   //   if (draftList.isNotEmpty) {
//   //     currentDraft = draftList.last;
//   //     draftList.removeLast();
//   //   }

//   //   // ✅ SAME STRUCTURE AS APPLICANT FILE
//   //   currentDraft["company"] = companyData;
//   //   currentDraft["lastStep"] = "applicantDetails";
...
//   //     context,
//   //     MaterialPageRoute(
//   //       builder: (context) => const ApplicantDetails(),
//   //     ),
//   //   );
...
//       //   isPanVerified = false;
//       // });
//       // print("Selected PAN: ${panFile!.name}");

//       // // 🔥 Upload PAN to same API
...
//         // _fileUploadField(
//         //   label: "Company PAN Card Upload",
//         //   // selectedFile: selectedPanFile,
//         //   // onPressed: _panUploadCard,
//         // ),
...
//   //     initialValue: selectedCompanyType,
//   //     decoration: _modernInputDecoration("Select company type"),
//   //     items: companyTypes
...
//             //             context: context,
//             //             onVerify: (otp) async {
//             //               await _verifyEmailOtp(otp); //  VERIFY
//             //             },
//             //           );
//             //         }
//             //       },
...
//   //   try {
//   //     final response = await http.post(
//   //       Uri.parse("https://sandbox.fintreelms.com/gst/verify"), // 🔴 replace
//   //       headers: {
//   //         "Content-Type": "application/json",
//   //         "x-api-key": "Fintree@2026", // if required
//   //       },
...
//   //         isGstInvalid = false;
//   //       });
//   //                              showTopToast(context, "GST verified successfully", success: true);
...
//   //         isGstInvalid = true;
//   //       });
//   //                 showTopToast(context, "GST verified failed", success: false);
