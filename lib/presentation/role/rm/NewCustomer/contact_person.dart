...
//     _expandedIndex = 0; //  first card open by default
//   }
...
//     showTopToast(context, "Contact persons saved successfully", success: true);
...
// // Update data
// currentDraft["contactPerson"] = contactPersonList;
...
// //   existingDraft["contactPerson"] = contactPersonList;
...
//   if (draft["contactPerson"] != null &&
//       draft["contactPerson"] is List &&
//       (draft["contactPerson"] as List).isNotEmpty) {
...
//       model.designationCtrl.text = item["gender"] ?? "";
//       model.gender = item["gender"] ?? "";

//       model.mobileVerified =
//           item["mobileVerified"] == true || model.mobileCtrl.text.length == 10;

//       model.emailVerified =
//           item["emailVerified"] == true || model.emailCtrl.text.contains("@");

//       contacts.add(model);
//     }
//   }

//   // 🔥 If nothing restored, add one blank card
//   if (contacts.isEmpty) {
//     contacts.add(ContactPersonModel());
//   }
...
Future<void> _saveContactPersonsToBackend() async {
 ...
 Future<void> _saveContactPersonDraft() async {
  ...
  await DraftService.saveWithStep(
    widget.customerId,
    "addressDetails",
    {
