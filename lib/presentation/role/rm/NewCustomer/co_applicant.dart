...
// // // import 'package:supply_chain/core/constants/app_strings.dart';
...
// // // (hereinafter referred to as “Lender”) or its associates/subsidiaries/affiliates
// // // to obtain, verify, exchange, share or part with all the information or otherwise,
// // // regarding my/our office/residence and/or contact me/us or my/our family/employer/
// // // Banker/Credit Bureau/RBI or any third parties as deemed necessary.

// // // I/We hereby authorise Lender’s employees/agents to access my/our premises
// // // during normal office hours for carrying out any verification/investigation
// // // which includes taking photographs and post disbursement scrutiny.

// // // I/We hereby provide my/our consent to receive information/services etc
// // // for marketing purpose through telephone/mobile/SMS/Email.
// // // ''';
...
// // //   void initState() {
// // //     super.initState();
// // //         _loadDraft();//  open first card by default
...
// // //   void _startOtpTimer(CoApplicantModel model) {
// // //     model.otpTimer?.cancel();
// // //     model.otpSeconds = 30;
// // //     model.canResendOtp = false;

// // //     model.otpTimer = Timer.periodic(const Duration(seconds: 1), (timer) {
// // //       if (model.otpSeconds == 0) {
// // //         timer.cancel();
// // //         setState(() => model.canResendOtp = true);
// // //       } else {
// // //         setState(() => model.otpSeconds--);
// // //       }
// // //     });
// // //   }
...
// // //   List<Map<String, dynamic>> coApplicantList =
// // //       coApplicants.map((model) {
// // //     return {
...
// // // }
// // // // Update data
// // // currentDraft["coApplicants"] = coApplicantList;
// // // currentDraft["lastStep"] = "contactPerson";
...
// // // //   existingDraft["coApplicants"] = coApplicantList;
// // // // existingDraft["lastStep"] = "contactPerson";

// // // //   await DraftService.saveDraft(existingDraft);
// // //    Navigator.push(
// // //     context,
// // //     MaterialPageRoute(
// // //       builder: (context) => const ContactPerson(),
// // //     ),
// // //   );
// // // }
...
// // //       model.panUploaded = model.panCtrl.text.isNotEmpty;
// // //       model.panOcrDone = model.panCtrl.text.isNotEmpty;
...
// // //   // 🔥 If still empty, add one blank card
// // //   if (coApplicants.isEmpty) {
// // //     coApplicants.add(CoApplicantModel());
// // //   }
...
// // //     setState(() {
// // //       coApplicants.add(CoApplicantModel());
// // //       _expandedIndex =coApplicants.length=-1;
// // //     });
// // //   }
...
// // //           _textField("Full Name", model.nameCtrl),
...
// // //                   decoration: _inputDecoration("PAN Number").copyWith(
...
// // //                   ),
// // //                   onPressed: () {
// // //                     setState(() => model.panVerified = true);
// // //                               showTopToast(context,AppStrings.panVerifiedTitle, success: true);
...
// // //   void _hitPanOcr(CoApplicantModel model) async {
// // //     await Future.delayed(const Duration(seconds: 1));
// // //     setState(() {
// // //       model.nameCtrl.text = "Vishal Yadav";
// // //       model.panCtrl.text = "ABCDE1234F";
...
// // //                   filled: true,
// // //                   fillColor: model.mobileVerified
...
// // //                   /// VERIFIED CHIP
// // //                   suffixIcon: model.mobileVerified ? _verifiedChip() : null,
// // //                 ),
// // //               ),
// // //             ),
...
// // //                     ? () {
// // //                         showMobileConsentPopup(
// // //                           context: context,
// // //                           onVerified: () {
// // //                             setState(() {
// // //                               model.mobileVerified = true;
// // //                                showTopToast(context, AppStrings.mobVerifiedTitle, success: true);
...
// // //         if (model.mobileOtpSent && !model.mobileVerified) ...[
// // //           const SizedBox(height: 12),
// // //           _otpRow(
// // //             controllers: model.mobileOtpCtrls,
// // //             onSubmit: () {
// // //               setState(() {
// // //                 model.mobileVerified = true;
// // //                 model.mobileOtpSent = false;
// // //                 model.otpTimer?.cancel();
// // //                 model.canResendOtp = false;
// // //               });
// // //             },
...
// // //                 onChanged: (_) => setState(() {}), // 🔑 revalidate live
// // //                 decoration: InputDecoration(
// // //                   hintText: "Enter email address",
// // //                   filled: true,
// // //                   fillColor: model.emailVerified
// // //                       ? AppColors.inputFill.withOpacity(0.5)
// // //                       : AppColors.inputFill,
...
// // //                   suffixIcon: model.emailVerified ? _verifiedChip() : null,
// // //                 ),
// // //               ),
// // //             ),
...
// // //                                         showTopToast(context, AppStrings.emailVerifiedTitle, success: true);
...
// // //         /// OTP SECTION (UNCHANGED)
// // //         if (model.emailOtpSent && !model.emailVerified) ...[
// // //           const SizedBox(height: 12),
// // //           _otpRow(
// // //             controllers: model.emailOtpCtrls,
// // //             onSubmit: () {
// // //               setState(() {
// // //                 model.emailVerified = true;
// // //                 model.emailOtpSent = false;
// // //                 model.otpTimer?.cancel();
// // //                 model.canResendOtp = false;
// // //               });
// // //             },
...
// // //   Widget _resendOtp(CoApplicantModel model, VoidCallback onTap) {
// // //     return Row(
// // //       mainAxisAlignment: MainAxisAlignment.spaceBetween,
// // //       children: [
// // //         if (!model.canResendOtp)
// // //           Text(
// // //             "Resend OTP in 00:${model.otpSeconds.toString().padLeft(2, '0')}",
// // //             style: TextStyle(
// // //               color: AppColors.textSecondary,
...
// // //         TextButton(
// // //           onPressed: model.canResendOtp
// // //               ? () {
// // //                   onTap();
// // //                   _startOtpTimer(model);
// // //                 }
// // //               : null,
// // //           child: Text(
// // //             "Resend OTP",
// // //             style: TextStyle(
// // //               color: model.canResendOtp ? AppColors.primary : AppColors.grey,
// // //               fontWeight: FontWeight.w600,
// // //             ),
// // //           ),
// // //         ),
...
// // //     if (_aadhaarStatus == AadhaarKycStatus.notStarted) return const SizedBox();
...
// // //       decoration: BoxDecoration(
// // //         borderRadius: BorderRadius.circular(14),
// // //         color: color.withOpacity(0.12), // glass effect
...
// // //                       showTopToast(context, AppStrings.aadhaarkycInitiated, success: true);
...
// // //                       showTopToast(context, AppStrings.aadhaarKycInprogress, success: true);
...
// // //         onTap = () async{
// // //                await _saveCoApplicantsDraft();   // 🔥 Auto Save
// // //                        showTopToast(context, AppStrings.aadhaarKycCompleted, success: true);
...
// //   const CoApplicantPage({super.key});
...
// //     //  sessionUid = _generateSessionUid();
// //     _loadDraft();
// //     coApplicants.add(CoApplicantModel());
// //     _expandedIndex = 0; //  open first card by default
// //   }
...
// //     Navigator.push(
// //       context,
// //       MaterialPageRoute(builder: (context) => const ContactPerson()),
// //     );
// //   }
...
// //               _aadhaarButton(model: model) //  SHOW CONTINUE IMMEDIATELY
// //             ],
// //           ],
// //         ],
// //       ),
...
// //     final extractedPan =
// //         result.panNumber!.trim().toUpperCase().replaceAll(RegExp(r'\s+'), '');
...
// //   final firstName =
// //       model.nameCtrl.text.trim().split(RegExp(r'\s+')).first;
...
// //   Future<void> _verifyMobileOtp (CoApplicantModel model, String otp) async {
...
// //             /// 🔁 SHOW SEND OTP OR VERIFIED ICON
// //             if (!model.mobileVerified)
// //               ElevatedButton(

// //                 onPressed: model.panUploaded
// //                     ? () async {
// //                         if (!_isValidMobile(model.mobileCtrl.text.trim())) {
// //                           showTopToast(
// //                             context,
...
// //                               await _verifyMobileOtp(model, otp);
// //                             },
// //                           );
// //                         }
// //                       }
...
// //               )
// //             else
// //               ///  GREEN VERIFIED ICON (REPLACES BUTTON)
...
// //             /// 🔁 SWITCH BETWEEN BUTTON & GREEN ICON
// //             if (!model.emailVerified)
// //               ElevatedButton(
// //                 style: ElevatedButton.styleFrom(
// //                   backgroundColor: isEmailValid
...
//             /// 📤 UPLOAD PAN
//             GestureDetector(
//               onTap: model.panVerified
//                   ? null
//                   : () => _pickPanSource(model),
//               child: Container(
//                 padding:
...
//       _isValidMobile(model.mobileCtrl.text.trim());
...
//       _isValidEmail(model.emailCtrl.text.trim());
