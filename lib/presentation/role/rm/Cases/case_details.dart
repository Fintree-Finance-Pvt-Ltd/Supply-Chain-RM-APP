...
class _CaseDetailsPageState extends State<CaseDetailsPage> {
      ...
      setState(() {
        ...
        caseData = {
          "customerProfile": {
            ...
            "status": customerBody["data"]?["status"],

            "assignedStage": customerBody["data"]?["assignedStage"],
          },
  ...
  Future<void> submitToMD() async {
    try {
      ...
      List<Map<String, dynamic>> partnerSanctions = sanctionList
          .where(
  ...
  Widget build(BuildContext context) {
    ...
    final status = caseData?["customerProfile"]?["status"]
        ?.toString()
        .toLowerCase()
        .trim();
    final bool canSubmitToMD = status?.contains("credit_l2_approved") == true;

    print("CASE STATUS => $status");
    print("CAN SUBMIT TO MD => $canSubmitToMD");
            ...
            children: [
              ...
              expandableCard(
                ...
                children: [
                  ...
                  _infoRow("GST", company["gstNumber"]?.toString() ?? "N/A"),

                  _infoRow("Remarks", company["remarks"]?.toString() ?? "N/A"),
                ],
              ),
              ...
              if (canSubmitToMD) nextStepSection(),
              const SizedBox(height: 16),
          ...
          ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final bool isApproved =
                  sanction["status"]?.toString().toLowerCase().trim() ==
                  "approved";
